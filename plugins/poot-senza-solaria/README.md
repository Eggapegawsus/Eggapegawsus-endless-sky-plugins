...
Senza Solaria is a small part of a much larger plugin called Peripherals Or Outstanding Trinkets (POOT).
However, I found Senza Solaria Station to be too fun to be only availble in POOT.
